...
mkdir -p "Calculator.AppDir"
cp -r ../appimage_deb/data/usr "Calculator.AppDir"
...
( cd "/home/tatar/.cache/tauri" && ( wget -q -4 -N https://github.com/AppImage/AppImageKit/releases/download/continuous/AppRun-${ARCH} || wget -q -4 -N https://github.com/AppImage/AppImageKit/releases/download/12/AppRun-${ARCH} ) )
chmod +x "/home/tatar/.cache/tauri/AppRun-${ARCH}"

# We need AppRun to be installed as Calculator.AppDir/AppRun.
# Otherwise the linuxdeploy scripts will default to symlinking our main bin instead and will crash on trying to launch.
cp "/home/tatar/.cache/tauri/AppRun-${ARCH}" AppRun

cp "usr/share/icons/hicolor/1000x1000/apps/calculator.png" .DirIcon
ln -sf "usr/share/icons/hicolor/1000x1000/apps/calculator.png" "Calculator.png"

ln -sf "usr/share/applications/Calculator.desktop" "Calculator.desktop"
...
( cd "/home/tatar/.cache/tauri" && wget -q -4 -N https://raw.githubusercontent.com/tauri-apps/linuxdeploy-plugin-gtk/master/linuxdeploy-plugin-gtk.sh )
( cd "/home/tatar/.cache/tauri" && wget -q -4 -N https://github.com/tauri-apps/binary-releases/releases/download/linuxdeploy/linuxdeploy-${linuxdeploy_arch}.AppImage )

chmod +x "/home/tatar/.cache/tauri/linuxdeploy-plugin-gtk.sh"
chmod +x "/home/tatar/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage"

dd if=/dev/zero bs=1 count=3 seek=8 conv=notrunc of="/home/tatar/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage"

OUTPUT="Calculator_0.1.0_amd64.AppImage" "/home/tatar/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage" --appimage-extract-and-run --appdir "Calculator.AppDir" --plugin gtk ${gst_plugin} --output appimage
